package com.minatodattebayo.thefourthhokagesir;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatodattebayo.thefourthhokagesir"})
@EnableCaching
...
public class TheFourthHokageSirApplication {

	public static void main(String[] args) {
		SpringApplication.run(TheFourthHokageSirApplication.class, args);
	}
